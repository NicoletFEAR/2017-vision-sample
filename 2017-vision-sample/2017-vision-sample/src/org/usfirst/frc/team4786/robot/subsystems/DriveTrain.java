...
public class DriveTrain extends Subsystem implements PIDOutput {
	...
	private VictorSP frontLeft = new VictorSP(RobotMap.frontLeftPort);
	...
	public boolean driveToPositionIsFinished() {
		return Math.abs(frontRight.getError()) <= RobotMap.ERROR_CONSTANT_LEFT && Math.abs(frontRight.getError()) <= RobotMap.ERROR_CONSTANT_RIGHT;
